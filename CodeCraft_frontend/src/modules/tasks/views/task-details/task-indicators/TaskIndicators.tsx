import { StatusSelector } from '@/modules/tasks/components/task-selectors/StatusSelector'
import { PrioritySelector } from '@/modules/tasks/components/task-selectors/PrioritySelector'
